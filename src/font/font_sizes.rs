...
lazy_static! {
    pub static ref CROSS_FONT_PDF: HashMap<Font, String> = {
...
lazy_static! {
    pub static ref CROSS_NAMED_FONT_TO_PDF: HashMap<String, String> = {
        let mut hsp = HashMap::new();
...
lazy_static! {
    pub static ref CROSS_PDF_NAME_FONT_TO_STRING_NAME: HashMap<String, String> = {
        let mut hsp = HashMap::new();
